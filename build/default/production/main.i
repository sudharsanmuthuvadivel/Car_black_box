...
void main(void) {
    ...
    unsigned char control_flag = 0x01, reset_flag, menu_pos;
    ...
    while (1) {
        ...
        else if(key == 0x80 && control_flag == 0x03)
        {
            switch(menu_pos)
            {
                ...
                case 2:
                    ...
                    clcd_print("Open", (0x80 + 5));
                    clcd_print("Cutecom", (0xC0 + 4));
                    control_flag = 0x07;
                    break;
                case 3:
                    clear_clcd_screen();
        ...
        else if (key == 0x80 && control_flag == 0x05)
        {
            clear_clcd_screen();
            control_flag = 0x03;
            reset_flag = 0x55;
        ...
        else if(key == 0x80 && control_flag == 0x09)
        {
            clear_clcd_screen();
            control_flag = 0x03;
            reset_flag = 0x55;
        ...
        speed = (unsigned char)(read_adc() / 10.25);
        ...
        switch(control_flag)
        {
            ...
            case 0x05:
                ...
                if(view_log(key, reset_flag) == 0x33)
                {
                    control_flag = 0x01;
                    clear_clcd_screen();
                    TMR2ON = 0;
            ...
            case 0x08:
                switch(change_time(key, reset_flag))
                {
                    case 0x77:
                        control_flag = 0x03;
                        reset_flag = 0x55;
